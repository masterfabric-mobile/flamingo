...
Submit your vulnerability via [this link](https://github.com/masterfabric-mobile/flamingo/security/advisories/new)
...
MasterFabric does not support other reporting platforms, all security vulnerabilities must be made via GitHub Advisory system. If you are unable to report via this method you may open a security ticket with us by emailing info@masterfabric.co and we will create one on your behalf but if you do not have a GitHub user account we will not be able to share the private fork, pull request, or any other information with you during the process.

List of some (though not all) platforms **we do not support**:

- huntr.dev
- Direct email or communication to MasterFabric employees (Discord, Slack, or Email)
- Stack Overflow

MasterFabric does not currently and has no plans to offer any bug bounties, swag, or any other reward for reporting vulnerabilities.